...
//                                
//            //设置发送人和接受人
//            Address sender=new InternetAddress("googlevsbing@126.com");
//            Address receiver=new InternetAddress("844063569@qq.com");
//                                
//            /*
//             * 群发邮件的方法
...
//            FileDataSource fds=new FileDataSource("D:/log/log.html");
//            DataHandler dh=new DataHandler(fds);
//            mdp.setFileName("log.doc");   //可以和原文件名不一致
